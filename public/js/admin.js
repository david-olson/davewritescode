...
var tinymceConfig = {
  ...
  toolbar: [{
    ...
    name: 'formatting',
    items: ['bold', 'italic', 'underline', "numlist", "bullist", 'link']
  }, {
    name: 'alignment',
    ...
    $('[data-parent="' + fieldId + '"]').each(function (i, e) {
      ...
      inputVals.forEach(function (x) {
        if (parentVal.includes(x)) {
          $(e).addClass('parent-active');
          console.log(e); // $('[data-parent="' + fieldId + '"][data-parent-value="' + originalParentVal + '"]').addClass('parent-active');
        } else {
          $(e).removeClass('parent-active');
        }
      });
...
function initPlugins() {
  ...
  $('.simple-editor').tinymce(tinymceConfigSimple); // $('.editor').tinymce(tinymceConfig);
...
module.exports = __webpack_require__(/*! /Users/davidolson/Code/davewritescode/resources/js/admin.js */"./resources/js/admin.js");
