...
class ProjectSeed extends Seeder
{
    ...
    public function run()
    {
        $projects[] = Project::create([
            ...
            'declaration' => 'Project planning, application architecture, and Back-End Development in Laravel. Data migration from multiple sources. Authentication identify provider for SSO with SAML2.',
        ...
        $projects[] = Project::create([
        	...
        	'order' => 1,
            'declaration' => 'Application Architecture and Full-Stack Web Development in Laravel. Multiple language translation. User customizeable content.',
        ...
        $projects[] = Project::create([
            ...
            'declaration' => 'Data migration and Full-Stack Web Development in WordPress. Custom Post Types, Custom Fields, and Google Maps integration.',
        ...
        $projects[] = Project::create([
            ...
            'declaration' => 'WordPress Custom Theme Development. In-Depth Site Structure.',
        ...
        $projects[] = Project::create([
            ...
            'declaration' => 'WordPress Custom Theme Development. Content access controlled via email list check using Mailchimp API.',
        ...
        $projects[] = Project::create([
        	...
        	'role' => 'Back-End',
        	'order' => 5,
            'declaration' => 'Art Competition Entry and Rating Software Built in Laravel. Back-End Development. Multi Authentication. Payment Processing via Authorize.net.',
        ...
        $projects[] = Project::create([
            ...
            'declaration' => 'Rapid Design and Development of Logo and Landing Page.',
        ...
        $projects[] = Project::create([
            ...
            'declaration' => 'Front-End Web Development and Icon Animation. Parallax Scene Animation. Collaborative Efforts With Designers.',
        ...
        $projects[] = Project::create([
            ...
            'declaration' => 'Front-End Web Development. Mutiple Sites Based on Origin Template. In-Depth Site Structure.',
        ...
        $projects[] = Project::create([
        	...
        	'role' => 'Full Stack',
        	'order' => 9,
        	'declaration' => 'Report Generation Tool with Multiple API Integrations and Scheduled Data Imports. Data Visualization.',
